...
cmd({
  ...
  try {
    ...
    if (m.mentionedJid.includes(botNumber)) {
      const thumbnailRes = await axios.get(config.MENU_IMAGE_URL || "https://files.catbox.moe/4ly65k.jpg", {
      ...
      await conn.sendMessage(m.chat, {
        ...
        contextInfo: {
          ...
          isForwarded: true,
          externalAdReply: {
            title: config.BOT_NAME || "𝗕𝗔𝗟𝗢𝗖𝗛-𝗠𝗗🥀",
            body: config.DESCRIPTION || "𝗕𝗔𝗟𝗢𝗖𝗛-𝗠𝗗 🤌💗",
            mediaType: 1,
            renderLargerThumbnail: true,
            thumbnail: thumbnailBuffer,
            mediaUrl: "https://files.catbox.moe/r2ncqh", // Static image URL
            sourceUrl: "+923357010910",
